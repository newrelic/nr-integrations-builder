...
func resourceTmplMakefileTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "resource/tmpl/Makefile.tmpl", size: 1660, mode: os.FileMode(420), modTime: time.Unix(1527172704, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func resourceTmplSrcIntegration_remoteGoTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "resource/tmpl/src/integration_remote.go.tmpl", size: 1507, mode: os.FileMode(420), modTime: time.Unix(1527602891, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
